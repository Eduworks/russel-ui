...
public class TileHandler {
	...
	public void addHooks() {	
		PageAssembler.attachHandler(idPrefix + "-objectClick", Event.ONCLICK, Constants.handlers.tileClickHandler(this));
...
//							else Window.alert(caught.getMessage());
	...
	public void assetAdd()
	{
		...
		td.setInnerHTML(Constants.templates.getEPSSNoteAssetObjectWidget().getText());
