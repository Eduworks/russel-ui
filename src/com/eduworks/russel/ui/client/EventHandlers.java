...
public class EventHandlers
{
	...
	public EventCallback goToEditScreen()
	{
		return new EventCallback()
		{
			...
			public void onEvent(Event event)
			{
				Constants.dispatcher.loadEditScreen();
			}
		};
	}
	...
	public EventCallback goToProjectsScreen()
	{
		return new EventCallback()
		{
			...
			public void onEvent(Event event)
			{
				Constants.dispatcher.loadFeatureScreen(FeatureScreen.PROJECTS_TYPE);
			}
		};
	}
	...
	public EventCallback goToCollectionsScreen()
	{
		return new EventCallback()
		{
			...
			public void onEvent(Event event)
			{
				Constants.dispatcher.loadFeatureScreen(FeatureScreen.COLLECTIONS_TYPE);
			}
		};
	}
	...
	public EventCallback goToAccountScreen()
	{
		return new EventCallback()
		{
			...
			public void onEvent(Event event)
			{
				Constants.dispatcher.loadUtilityScreen(UtilityScreen.ACCOUNT_TYPE);
			}
		};
	}
	...
	public EventCallback goToUsersScreen()
	{
		return new EventCallback()
		{
			...
			public void onEvent(Event event)
			{
				Constants.dispatcher.loadUtilityScreen(UtilityScreen.USERS_TYPE);
			}
		};
	}
	...
	public EventCallback goToGroupsScreen()
	{
		return new EventCallback()
		{
			...
			public void onEvent(Event event)
			{
				Constants.dispatcher.loadUtilityScreen(UtilityScreen.GROUPS_TYPE);
			}
		};
	}
	...
	public EventCallback goToRepositorySettingsScreen()
	{
		return new EventCallback()
		{
			...
			public void onEvent(Event event)
			{
				Constants.dispatcher.loadUtilityScreen(UtilityScreen.REPSETTINGS_TYPE);
			}
		};
	}
